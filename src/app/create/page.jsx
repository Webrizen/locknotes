    ...
    <>
      <section className="min-h-screen flex items-center justify-center">
        <div className="p-8 rounded-lg shadow-lg w-full md:w-2/3 lg:w-1/2">
          <h1 className="text-3xl font-semibold mb-4">Create a Secret Note</h1>
          <textarea
          ...
          {isNoteVisible && (
            <div className="mt-4">
              ...
              <input type="text" className="w-full p-4 outline-none border-gray-100 bg-transparent" readOnly value={generatedLink} ref={linkInputRef} />
              <IconButton
                onClick={() => {
