  ...
  return (
    <>
      ...
      <section className="mb-32">
        <div
          className="block container mx-auto rounded-lg bg-[rgba(225,225,225,0.2)] shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
              <div className="px-6 py-12 md:px-12">
                ...
                <p className="mb-6 flex items-center font-bold uppercase text-yellow-900">
