        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="rounded-lg shadow-md p-6 border dark:border-gray-900">
                <Image
              ...
              <div className="rounded-lg shadow-md p-6 border dark:border-gray-900">
                <Image
                  ...
                  height={200}
                />
                <h3 className="text-xl font-semibold">Karan Singh</h3>
                <p className="dark:text-gray-400">
                  Introducing Karan Singh, a 23-year-old Website Developer and
